    ...
    <div id="page-wrapper">
        <div class="row">
            <div class="col-lg-12">
                ...
                <h1 class="page-header float-right">ایجاد ویدئو</h1>
        ...
        <div class="row">
            <div class="col-lg-12">
                <form name="campaignForm" action="{{ route('episodes.store') }}" class="form-horizontal" method="post"
                    ...
                    <div class="form-group">
                        ...
                        <div class="div col-sm-6">
                            ...
                            <input type="text" id="number" class="form-control" name="number"
                                   placeholder="لینک را وارد کنید..." value="{{ old('number') }}">
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="div col-sm-6">
                            ...
                            <input type="text" id="videoUrl" class="form-control" name="videoUrl"
                                   placeholder="لینک را وارد کنید..." value="{{ old('videoUrl') }}">
                        </div>
